...
class StoreAppointmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pwd'                       => ['nullable', 'in:Yes,No,N/A'],
            'type_of_disability'        => ['nullable', 'string', 'max:255'],
            'ip_group_member'           => ['nullable', 'in:Yes,No,N/A'],
            ...
            'nature_of_appointment' => ['required', 'in:Original,Promotion,Demotion,Transfer,Reclassification,Reemployment,Reappointment'],
    ...
    public function messages(): array
    {
        return [
            ...
            'nature_of_appointment.in' => 'The selected nature of appointment is invalid.',
        ];
    }
}
